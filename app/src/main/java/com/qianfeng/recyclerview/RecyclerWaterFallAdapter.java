 ...
 *
 */
public class RecyclerWaterFallAdapter extends
        RecyclerView.Adapter<RecyclerWaterFallAdapter.MyViewHolder>
{
    ...
    public RecyclerWaterFallAdapter(Context context, List<String> list)
    {
        ...
        {
            heights.add(random.nextInt(300));
        }
    }
